...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><div class="container copyright" data-v-2e25fbfa> \xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Connect Pro AI. All rights reserved. </div></footer>`);
}
...
export { SiteHeader as S, SiteFooter as a };
//# sourceMappingURL=SiteFooter-DAn3oYoO.mjs.map
